      ...
      <ul className="contacts__list">
        <li className="contacts__list-item">
          ...
          <a
            ...
            href="https://github.com/VKharlakov/guild-roster-manager"
            rel="noreferrer"
            target="_blank"
          >
            GitHub
        ...
        <li className="contacts__list-item">
          ...
          <a
            className="contacts__link"
            href="https://www.linkedin.com/in/vkharlakov/"
            rel="noreferrer"
            target="_blank"
          >
            Author on LinkedIn
        ...
        <li className="contacts__list-item">
          ...
          <CopyToClipboard text="guildrostermanager@gmail.com" onCopy={onCopy}>
            <p className="contacts__text contacts__text_type_email">
              ...
              <span
                className={`contacts__alert${
                  isCopied ? "" : " contacts__alert_hidden"
                }`}
              >
                Copied to clipboard!
              </span>
