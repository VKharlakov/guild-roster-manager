        ...
        <header className="header">
          <nav
            className={`header__nav ${
              currentPath === "/" ? "header__nav_type_home" : ""
            }`}
          >
            <NavLink
              className={({ isActive }) =>
                isActive
                  ? "header__link header__link_type_home header__link_active"
                  : "header__link"
              }
              to={"/"}
            >
            ...
            <>
              <span
                className={`header__link-arrow ${
                  currentPath === "/" ? "header__link-arrow_hidden" : ""
                }`}
              />
              <NavLink
                className={({ isActive }) =>
          ...
          {currentPath === "/guilds" && (
            <div className="header__add">
              <label className="header__add-label" htmlFor="add">
                Add
              </label>
              <button
